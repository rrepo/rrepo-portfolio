...
o888o         88ooo88  o888o  88o8    o888o    o888o        88ooo88  o888ooooo88 o888o  88ooo88   \n
      ...
      loaderSTL.load(
        ...
        (geometry: THREE.BufferGeometry) => {
          ...
          // 位置を設定
          const position = new THREE.Vector3(0.1, deskY - 0.35, 0.5); // ここを好きな座標に変更
          stlMesh1.position.copy(position);
      ...
      loaderSTL.load(
        ...
        (geometry: THREE.BufferGeometry) => {
          ...
          const material = new THREE.MeshToonMaterial({ color: "gray" });
          stlMesh2 = new THREE.Mesh(geometry, material);
          stlMesh2.rotation.x = Math.PI / -2;

          // 位置を設定
          const position = new THREE.Vector3(-0.5, deskY - 0.35, 0.5); // ここを好きな座標に変更
          stlMesh2.position.copy(position);
